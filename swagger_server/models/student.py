...
class Student(Model):
    ...
    """
    def __init__(self, student_id: int=None, first_name: str=None, last_name: str=None, grade_reccords: List[GradeRecord]=None):  # noqa: E501
        ...
        :type last_name: str
        :param grade_reccords: The grade_reccords of this Student.  # noqa: E501
        :type grade_reccords: List[GradeRecord]
        """
        self.swagger_types = {
            'student_id': int,
            'first_name': str,
            'last_name': str,
            'grade_reccords': List[GradeRecord]
        }
        ...
        self.attribute_map = {
            ...
            'last_name': 'last_name',
            'grade_reccords': 'gradeReccords'
        }
        self._student_id = student_id
        self._first_name = first_name
        self._last_name = last_name
        self._grade_reccords = grade_reccords
    ...
    @property
    def grade_reccords(self) -> List[GradeRecord]:
        """Gets the grade_reccords of this Student.


        :return: The grade_reccords of this Student.
        :rtype: List[GradeRecord]
        """
        return self._grade_reccords

    @grade_reccords.setter
    def grade_reccords(self, grade_reccords: List[GradeRecord]):
        """Sets the grade_reccords of this Student.


        :param grade_reccords: The grade_reccords of this Student.
        :type grade_reccords: List[GradeRecord]
        """
